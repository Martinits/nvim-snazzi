...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    TodoBgHACK   {fg=gray_11, bg=Todo.bg, gui='bold,italic,nocombine'},
    TodoBgNOTE   {fg=gray_11, bg=Hint.bg, gui='bold,italic,nocombine'},
    TodoBgPERF   {fg=gray_11, bg=Info.bg, gui='bold,italic,nocombine'},
    TodoBgTODO   {fg=gray_11, bg=cyan, gui='bold,italic,nocombine'},
    TodoBgWARN   {fg=gray_11, bg=Warning.bg, gui='bold,italic,nocombine'},
